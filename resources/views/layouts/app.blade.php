                    ...
                    <div class="space-y-2">
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" x-transition class="mt-2 space-y-1 pl-4">
                                <a href="{{route('lang','en')}}" class="flex items-center space-x-2 text-gray-300 hover:text-white hover:bg-gray-700 px-3 py-2 rounded-md">
                                    <img src="{{ asset('imgs/eeuu_flag.jpeg') }}" class="w-5 h-5" alt="EN" loading="lazy">
                                    <span>EN</span>
                                </a>
                                <a href="{{route('lang', 'es')}}" class="flex items-center space-x-2 text-gray-300 hover:text-white hover:bg-gray-700 px-3 py-2 rounded-md">
            ...
            <nav class="w-full h-auto p-4 flex justify-between items-center bg-gray-800">
                ...
                <div class="hidden sm:flex items-center space-x-6">
                    <x-dropdown width="48">
                        ...
                        <x-slot name="content">
                            <a class="block w-full px-2 py-1 text-start text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out" href="{{route('lang','en')}}">
                                EN
                                <i class="inline-block ml-2">
                                    <img class="w-5 h-5 inline-block" src="{{ asset('imgs/eeuu_flag.jpeg')}}" alt="EN" loading="lazy">
                                </i>
                            </a>
                            <a class="block w-full px-2 py-1 text-start text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out" href="{{route('lang','es')}}">
                                ES
                                <i class="inline-block ml-2">
